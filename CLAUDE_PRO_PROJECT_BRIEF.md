...
| Post | URL | File |
|---|---|---|
| OpenClaw Multi-Model Router | /posts/openclaw-multi-model-router.html | `posts/openclaw-multi-model-router.html` |
...
| 2 | OpenClaw Multi-Model Router | /posts/openclaw-multi-model-router.html | 🧠 `&#x1F9E0;` |
| 3 | AI Chief of Staff Setup | /posts/ai-chief-of-staff.html | 🎩 `&#x1F3A9;` |
| 4 | Claude Morning Brief Setup | /posts/morning-brief.html | ☀️ `&#x2600;` |
| 5 | Room Layout Tool | https://mcornelia.github.io/room-layout-tool | 📐 `&#x1F4D0;` |
| 6 | Mountain Mesh Setup Guide | https://mcornelia.github.io/mountain-mesh-node-guide | 📡 `&#x1F4E1;` |
...
| `mcornelia/openclaw-multi-model-router` | https://github.com/mcornelia/openclaw-multi-model-router | Public guide + minimal repo for a 3-model AI router (Gemma + Qwen + Claude) that runs alongside OpenClaw. Local clone lives in gdrive at `01_projects/22_openclaw_multi_model_router/`. README + start.sh + plist + router.py stub (real router.py source pending). README-only style, no styled HTML. |
